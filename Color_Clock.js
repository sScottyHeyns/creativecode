...
function draw() {
  ...
  fill(255);
  //Update balls
  sec_height= ((height/8.5)*abs(sin((2*PI*mill)-sec_phase))) + ((17.25*height/20)*abs(cos((2*PI*mill)-sec_phase)));
  min_height= (((height*3)/20)*abs(sin((PI*mill/60)-min_phase))) + (((height*5)/6)*abs(cos((PI*mill/60)-min_phase)));
  hr_height= ((height/5)*abs(sin((PI*mill/1800)-hour_phase))) + ((height*3/10)*abs(cos((PI*mill/1800)-hour_phase)));
  ...
  //bottom bar, whose color changes every 40 frames
